...
const defaultMentions: MentionNotification[] = [
  {
    ...
    body: "@DemoStudent start from the research idea, but quickly check whether the data can actually measure it.",
  ...
  },
  {
    ...
    body: "@DemoStudent keep the email short and specific. Mention one paper and one clear research fit.",
