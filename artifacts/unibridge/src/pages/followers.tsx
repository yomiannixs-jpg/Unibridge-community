...
import { loadSocialStore, toggleFollowPerson, type SocialPerson, type SocialStore } from "@/lib/social-store";
      ...
      <div className="flex items-start justify-between gap-4">
        ...
        <button
          ...
          className={`rounded-full px-4 py-2 text-sm font-bold ${
            person.followed ? "bg-blue-50 text-blue-800" : "bg-blue-800 text-white hover:bg-blue-900"
          }`}
        >
...
export default function FollowersPage() {
  ...
  const people = [...store.followers, ...store.following].filter(
